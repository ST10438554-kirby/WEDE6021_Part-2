...
<tr>
    ...
    <td>
        ...
        <a class="btn edit" href="edit_product.php?id=<?php echo $row['product_id']; ?>">
            Edit
        </a>

        <a class="btn delete" href="delete_product.php?id=<?php echo $row['product_id']; ?>">
            Delete
        </a>

        <?php if($row['approved'] == 0){ ?>
        <a class="btn approve" href="approve_product.php?id=<?php echo $row['product_id']; ?>">
            Approve
        </a>
        <?php } ?>
